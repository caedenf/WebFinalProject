...
<html lang="en" dir="ltr">
  <head>
    ...
    @media screen and (max-width: 375px) {
      ...
      body {
        background-image: linear-gradient(to bottom right, #000000, #78FFD6);
      }
    }
      html {
        height: 100%;
      ...
      .songFeedback:hover {
        box-shadow: -7px 15px 30px rgba(0, 0, 0, 0.6);
        transition: 0.2s;
      }
...
.close:hover {
  ...
  <body>
    <nav>
      ...
      <a href="#about" style="float: right; margin-top: 20px; margin-right: 3%;font-weight: 500;">About Us</a>

      <div id="about" class="modalDialog">
          <div> <a href="#close" title="Close" class="close">X</a>

                <h2 style="text-align: center; font-size: 70px;font-weight: 500;">About Us</h2>

              <p style="text-align: center; font-size: 30px;">We care about music. We care about you.</p>

              <p style="text-align: center; font-style: italic;font-weight: 100" >
                Moodify was founded in 2019 by four Tufts University undergrads with two things in common:
                a love for music and a passion for shortcuts.
                Together, they found an easy way to do a great thing.
                Quick access to the best songs for every mood, Moodify wants you to listen with your heart. </p>
          </div>
      </div>
    </nav>
    ...
    <div class="mainSentence">
      ...
      <div style="text-align:center;" id="mainSearchSentence">
        <span>Gimme A Word</span> <br>
        <!-- <span id="changeText">HAPPY</span> &nbsp -->
        <input type="text" name="" value="" id="changeText" placeholder="HAPPY">


        <!-- give some emoji examples for fun -->
        <div class="emojis">
          <span id="happy"> 😃</span>
          <span id="ironic">🙃</span>
          <span id="kiss">  😘</span>
          <span id="kidding">😛</span>
          <span id="notHappy">😐</span>
          <span id="deadly">💀</span>
          <span id="sad">😥</span>
          <span></span>
          <span></span>
...
<script src="https://www.gstatic.com/firebasejs/7.5.0/firebase-analytics.js"></script>
    ...
    <script type="text/javascript">
      ...
      var textDemoArr = ["Kalid","PARTY","RELAXING","CALMING","HAPPY"];
      var counter = 0;
      ...
      function makePlaylist(data) {
        ...
        for (var i = 0; i < songArray.length; i++) {
          ...
          console.log(songArray[i].preview);
